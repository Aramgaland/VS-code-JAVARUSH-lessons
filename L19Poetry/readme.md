...
<!-- потом переходим в директорию L17Poetry -->
 ...
 python -m venv venvL19 \\\\ эта команда создает вирт окружение в данной папке \\\ повтор того что было выше... тут в конце еще название указывается
...
poetry show   ///// gjrfpfnm pfdbcbvjcnb
...
C:\Users\ACER\AppData\Local\Programs\Python\Python312\python.exe -m venv venvL20
